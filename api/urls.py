...
urlpatterns = [
    ...
    path('client-ip/', ClientIpView.as_view(), name='client_ip'),
    ...
    path('artist/songs/uploads/<str:upload_id>/', ArtistSongUploadStatusView.as_view(), name='artist_song_upload_status'),
    ...
    path('admin/finance/artist-earnings/', AdminArtistEarningsListView.as_view(), name='admin_artist_earnings'),
    ...
    path('admin/playlist-builder/', AdminPlaylistBuilderView.as_view(), name='admin_playlist_builder'),
    ...
    path('admin/session/', AdminPanelSessionView.as_view(), name='admin_panel_session'),
    ...
    path('admin/employees/<int:pk>/password/', AdminEmployeePasswordView.as_view(), name='admin_employee_password'),
