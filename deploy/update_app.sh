...
# This migration was generated by the previous unsafe UID field definition. It
# failed transactionally on existing databases but remains untracked locally.
rm -f api/migrations/0042_playlist_unique_id_userplaylist_unique_id.py
set +e
